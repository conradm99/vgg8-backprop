...
void top(                           // top level entity that connects forward pass and backward propagation 
...
cnn(inputData, outputData, paramVector, intermediateResultBuffer); // call the cnn function, perform forward prop

bp(intermediateResultBuffer, postActPrevLayer, outputGradients, weights, bias); // call the bp function, perform backpropagation
