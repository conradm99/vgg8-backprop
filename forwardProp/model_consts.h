...
const int INPUT_DEPTH_0 = 1;
const int INPUT_ROWS_0 = 1024;
const int INPUT_COLS_0 = 2;
const int NUM_KERNELS_0 = 12;
const int KERNEL_ROW_0 = 1;
const int KERNEL_COL_0 = 3;
const int CONV_OUTPUT_SIZE_0 = 24;
...
const int INPUT_COLS_1 = 2;
const int RELU_OUTPUT_SIZE_1 = 24;
...
const int INPUT_COLS_3 = 2;
const int RELU_OUTPUT_SIZE_3 = 24;
...
const int INPUT_COLS_4 = 2;
const int POOL_ROW_4 = 1;
const int POOL_COL_4 = 2;
const int MAX_POOL_OUTPUT_SIZE_4 = 12;
...
const int INPUT_COLS_6 = 1;
const int RELU_OUTPUT_SIZE_6 = 24;
...
const int INPUT_COLS_8 = 1;
const int RELU_OUTPUT_SIZE_8 = 24;
...
const int INPUT_COLS_9 = 1;
const int POOL_ROW_9 = 1;
const int POOL_COL_9 = 2;
const int MAX_POOL_OUTPUT_SIZE_9 = 0;
...
const int INPUT_COLS_11 = 0;
const int RELU_OUTPUT_SIZE_11 = 0;
...
const int INPUT_COLS_13 = 0;
const int RELU_OUTPUT_SIZE_13 = 0;
...
const int INPUT_COLS_14 = 0;
const int POOL_ROW_14 = 1;
const int POOL_COL_14 = 2;
const int MAX_POOL_OUTPUT_SIZE_14 = 0;
...
const int INPUT_COLS_15 = 0;
const int FLATTEN_OUTPUT_SIZE_15 = 0;

fixedP outputFlattenLayer_15 [FLATTEN_OUTPUT_SIZE_15];

/* LAYER 15 (FC) */

const int INPUT_SIZE_15 = 0;
